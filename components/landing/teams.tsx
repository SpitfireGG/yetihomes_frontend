    ...
    <div className="font-sans antialiased text-on-surface">
      <div className="w-full max-w-[1600px] mx-auto overflow-hidden flex flex-col pt-0 pb-0 relative group">
        ...
        <button
          ...
          className="hidden md:flex absolute right-4 top-[55%] -translate-y-1/2 z-20 w-12 h-12 bg-surface-container-lowest/90 backdrop-blur-md border border-outline-variant rounded-full items-center justify-center text-on-surface-variant shadow-lg opacity-50 group-hover:opacity-100 transition-all duration-300 hover:scale-110 hover:text-primary"
        >
